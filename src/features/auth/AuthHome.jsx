...
export function AuthHome({ onLogin }) {
  ...
  if (!started) return <LandingIntro onStart={() => setStarted(true)} />;

  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.28),transparent_32%),radial-gradient(circle_at_bottom_right,rgba(132,204,22,0.28),transparent_30%),linear-gradient(135deg,#f8fdff,#ecfeff_48%,#f7fee7)] px-4 py-8 text-foreground">
      <section className="container grid min-h-[calc(100vh-4rem)] items-center gap-8 lg:grid-cols-[1fr_420px]">
        ...
        <Card className="border-cyan-100 bg-white/90 shadow-2xl backdrop-blur">
          <CardHeader>
